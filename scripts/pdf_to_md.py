...
from headings import (  # noqa: F401  # re-exportado (fachada) + usado por build_ast/build_markdown
    _ARTICLE_REF_TRAILING_RE,
    ARTICLE_ORDINAL_RE,
    FRACCION_ROMAN_RE,
    INCISO_RE,
    TRANSITORIO_HEADING_RE,
    TRANSITORIO_ORDINAL_RE,
...
# is_article_heading / split_article_heading + regex de ordinales/transitorios/
# fracciones/incisos viven ahora en headings.py (importados arriba, fachada — 3.1).
...
# _is_roman_numeral, regex de sección, _match_section_heading, is_section_heading,
# _is_descriptive_name viven ahora en headings.py (importados arriba, fachada — 3.1).
